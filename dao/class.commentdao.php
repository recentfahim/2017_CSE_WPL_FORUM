...
Class CommentDAO{
	...
	public function createComment($Comment){
		...
		//$Creator = "{8B24B76D-9969-4F71-ABC4-6EE59355C686}";
		//$Creator=$Comment->getCreator();
		//$CommentIDTop=$Comment->getCommentIDTop();

		$SQL = "INSERT INTO tbl_discussion_comment(CommentID,DiscussionID,Comment,CreatorID) 
				VALUES('$CommentID','$DiscussionID','$Comment','$Creator')";
